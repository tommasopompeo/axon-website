...
- **Stat** (`--fs-stat`): `clamp(2.5rem, 5vw, 3.75rem)` — dati bento/risultati; sono `<span>`/`<p>`, non titoli, e restano bold/extrabold di proposito.
